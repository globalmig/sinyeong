        ...
        <article className="bg-[url(/images/introduce-bg.jpg)] bg-center bg-no-repeat bg-cover">
            <div>
                ...
                <div>
                    ...
                    <p>신영이앤디는 방수 도료, 건축 내외장재, 도로 포장, 교통안전 분야의 자재 공급 및 시공 솔루션을 제공하는 전문 기업으로서, <br className="hidden pc:block"/> 고객님께 최고의 만족을 드리기 위해 최선을 다합니다.</p>
                </div>
                    ...
                    {INTRODUCE_INFO.map((info, idx) => (
                        ...
                        bg-blue-dark nth-[2]:bg-[#81A4D3] last-of-type:bg-[#A6BAD4]">
                            <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
                                ...
                                <h4 className="mt-2.5 text-white pc:mt-3.75 pc:text-[1.5rem]">{info.name}</h4>
                            </div>
                        </section>
                    ))}
                </div>
